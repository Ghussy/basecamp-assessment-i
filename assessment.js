...
function responseCreator (ParamValue){ 
  if(ParamValue == 'green'){colorResponse="Green is Okay";}
  else if (ParamValue == 'red'){colorResponse="I heart red";}
...
function greeter (name, number){
  return "Hi! I am " + name + "and I am a " + number + "years old"
}
